...
export const metadata: Metadata = {
  ...
  description:
    'Demande de devis gratuit, renseignements, ou simplement être rappelé, n´hésitez pas à me contacter. Chambéry et ses alentours (jusqu´à 30 km).',
}
        ...
        <div className="mx-auto max-w-2xl space-y-16 divide-y divide-gray-100 lg:mx-0 lg:max-w-none">
              ...
              <div className="rounded-2xl bg-gray-50 p-10">
                ...
                <dl className="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                  <div>
                    ...
                    <dd>
                      <a
                        href="mailto:carvalhohatf@gmail.com"
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 pt-16">
            ...
            <div className="grid grid-cols-1 overflow-hidden rounded-2xl">
              <Image src={chamberyImage} alt="" width={1944} height={1141} />
            </div>
          </div>
        </div>
      </div>
